...
import imageParty from "../images/polttarit-siltakeinu.jpg";
...
const features = [
  "Uniikkia kokemusta polttarisankari muistelee varmasti vielä vuosikymmenten päästä kiikkustuolissa keinuen.",
  "Halutessaan koko polttariseurue pääsee testaamaan kanttiaan köysielämysten parissa. Yhteisiä kokemuksia on mukava fiilistellä jälkikäteen.",
  "Jokainen polttariseurueen jäsen saa muistoksi GoPro -videon, jonka voi jakaa halutessaan vaikka hääjuhlassa.",
...
const services = [
  {
    ...
    price: "150 €",
    description:
      "Köysilaskeutuminen legendaarisesta Matti Nykäsen mäkihyppytornista on polttariasiakkaidemme kestosuosikki – eikä suotta. Laajavuoren nyppylällä seisova 58 metriä korkea torni tarjoaa ympäri Jyväskylän uskomattomat näkymät, joista pääsevät nauttimaan kaikki polttariseurueen jäsenet. Jokainen osallistuja määrää itse vauhtinsa, joten Jyväskylän komeista maisemista voi nautiskella oman mielensä mukaan.",
    imageSrc: imageRappelling,
    imageAlt: "Köysilaskeutuminen mäkihyppytornista",
    actionButtonText: "VARAA AIKA POLTTARIRYHMÄLLE!",
  ...
  },
  {
    ...
    price: "100 €",
    description:
      "Vauhdikas siltakeinu Kinakujan sillalta on kirkkaasti toiseksi suosituin polttarielämyksemme. Siltakeinu on jättimäinen sillan rakenteisiin viritetty keinu, jonka kyytiin hypätään valjaisiin kiinnitettynä sillan laidalta. Siltakeinu saa taatusti adrenaliinin virtaamaan polttarisankarin suonissa. Sillan sijainti on polttareita ajatellen erinomainen: muutaman sadan metrin päässä Jyväskylän keskustasta.",
    imageSrc: imagePendulum,
    imageAlt: "Siltakeinu Kinakujan sillalla",
    actionButtonText: "EI SAATAVILLA KAUDELLA 2024",
    actionButtonUrl: "#",
    videoButtonText: "KATSO VIDEO",
  ...
  },
  {
    ...
    price: "200 €",
    description:
      "Kiipeily luonnon kallioilla on reipas valinta polttareille – luontoliikuntaa parhaimmillaan! Polttariseurueen kiipeilykokeilu suunnitellaan aina ryhmäkohtaisesti, jotta jokainen pääsee haastamaan sopivasti itseään. Et tarvitse kuitenkaan aiempaa kiipeilykokemusta, voimaa tai notkeutta vaan kiipeily sopii käytännössä kenelle tahansa. Tässä polttariaktiviteetissa yhteishenki hioutuu, kun kaikki tsemppaavat toisiaan.",
...
const seo = {
  title: "Polttarit Jyväskylä | Huvimestari",
  description:
    "Suunnitteilla polttarit Jyväskylän seudulle? Huvimestari tarjoaa jännittäviä ja vauhdikkaita aktiviteetteja: köysilaskeutuminen, siltakeinu ja kalliokiipeily.",
};
      ...
      <div className="bg-white sm:py-8">
            ...
            <div className="relative shadow-xl sm:rounded-2xl sm:overflow-hidden">
              ...
              <div className="relative px-4 py-16 sm:px-6 sm:py-24 lg:py-32 lg:px-8">
                <h1 className="block text-gray-100 text-center text-4xl font-extrabold tracking-tight sm:text-5xl lg:text-6xl">
                  Polttarit Jyväskylässä
                </h1>
                <p className="mt-6 max-w-lg mx-auto text-center text-xl text-gray-100 sm:max-w-3xl">
                  Oletko järjestämässä polttarit Jyväskylässä tai muualla
                  Keski-Suomessa? Mikä olisikaan mahtavampi kohokohta
                  polttareille kuin yllättää tuleva morsian tai sulhanen
                  ikimuistoisella elämyksellä? Huvimestarin köysielämys on
                  nappivalinta polttariaktiviteetiksi. Takaamme, että jokainen
                  polttariseurue saa iloisen piristysruiskeen päiväänsä
                  Huvimestarin köysikeikalta.
                </p>
        ...
        <div className="bg-white py-8 sm:py-16">
          {services.map((service) => (
            <div
              className="mx-auto py-8 px-4 sm:px-6 lg:max-w-7xl lg:py-2 lg:px-8"
              key={service.title}
            >
              <div className="lg:grid lg:grid-rows-1 lg:grid-cols-7 lg:gap-x-8 lg:gap-y-10 xl:gap-x-16">
                ...
                <div className="max-w-2xl mx-auto mt-4 lg:mt-2 lg:max-w-none lg:mt-0 lg:row-end-2 lg:row-span-2 lg:col-span-3">
                  ...
                  <p className="text-gray-500 mt-4 text-base md:text-lg lg:text-base">
                    {service.description} Tilausryhmien hinnat alkaen{" "}
                    {service.price}.
                  </p>
          ...
          <div className="max-w-7xl mx-auto py-2 px-4 sm:py-8 sm:px-6 lg:px-8">
            <div className="xl:grid xl:grid-cols-3 xl:gap-x-8">
              <h1 className="mt-2 text-3xl font-extrabold text-gray-900">
                Miksi valita köysielämys polttariaktiviteetiksi Jyväskylässä?
              </h1>
              ...
              <div className="relative z-10 lg:col-start-1 lg:row-start-1 lg:col-span-4 lg:py-16 lg:bg-transparent">
                ...
                <div className="max-w-md mx-auto px-4 sm:max-w-3xl sm:px-6 lg:max-w-none lg:p-0">
                  <div className="aspect-w-1 aspect-h-1">
                    <Image
                      src={imageParty}
                      alt="Hauskat polttarit Jyväskylässä"
                      layout="fill"
                    />
                  </div>
                </div>
              ...
              <div className="relative bg-yellow lg:col-start-3 lg:row-start-1 lg:col-span-10 lg:rounded-3xl lg:grid lg:grid-cols-10 lg:items-center">
                ...
                <div className="relative max-w-md mx-auto py-12 px-4 space-y-6 sm:max-w-3xl sm:py-16 sm:px-6 lg:max-w-none lg:p-0 lg:col-start-4 lg:col-span-6">
                  ...
                  <p className="text-lg text-gray-800">
                    Jyväskylän parhaat polttarit ovat vain klikkauksen päässä.
                    Kysy lisää vauhdikkaista polttarielämyksistämme tai varaa
                    seurueellesi sopiva aktiviteetti saman tien
                    varauskalenteristamme. Erityisesti kesäviikonloput viedään
                    nopeasti käsistä, joten kipin kapin varailemaan.
                  </p>
                  <a
