...
const seo = {
  ...
  description: "Suunnitteilla polttarit Jyväskylän seudulle? Huvimestari tarjoaa jännittäviä ja vauhdikkaita aktiviteetteja: köysilaskeutuminen, siltakeinu ja kalliokiipeily."
}
          ...
          <div className="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div className="relative shadow-xl sm:rounded-2xl sm:overflow-hidden">
              ...
              <div className="relative px-4 py-16 sm:px-6 sm:py-24 lg:py-32 lg:px-8">
                ...
                Oletko järjestämässä polttarit Jyväskylässä tai muualla Keski-Suomessa? Mikä olisikaan mahtavampi kohokohta polttareille kuin yllättää tuleva morsian tai sulhanen ikimuistoisella elämyksellä? Huvimestarin köysielämys on nappivalinta polttariaktiviteetiksi. Takaamme, että jokainen polttariseurue saa iloisen piristysruiskeen päiväänsä Huvimestarin köysikeikalta.
                </p>
        ...
        <div className="bg-white">
          <div className="max-w-7xl mx-auto py-2 px-4 sm:py-8 sm:px-6 lg:px-8">
            <div className="xl:grid xl:grid-cols-3 xl:gap-x-8">
              <h1 className="mt-2 text-3xl font-extrabold text-gray-900">Miksi valita köysielämys polttariaktiviteetiksi Jyväskylässä?</h1>
            ...
            <div className="lg:grid lg:grid-cols-12">
              ...
              <div className="relative bg-yellow lg:col-start-3 lg:row-start-1 lg:col-span-10 lg:rounded-3xl lg:grid lg:grid-cols-10 lg:items-center">
                ...
                <div className="relative max-w-md mx-auto py-12 px-4 space-y-6 sm:max-w-3xl sm:py-16 sm:px-6 lg:max-w-none lg:p-0 lg:col-start-4 lg:col-span-6">
                  ...
                  Jyväskylän parhaat polttarit ovat vain klikkauksen päässä. Kysy lisää vauhdikkaista polttarielämyksistämme tai varaa seurueellesi sopiva aktiviteetti saman tien varauskalenteristamme. Erityisesti kesäviikonloput viedään nopeasti käsistä, joten kipin kapin varailemaan.
                  </p>
                  <a
