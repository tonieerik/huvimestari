...
const seo = {
  ...
  description: "Tule tutustumaan Suomen talviseen luontoon elämyksellisellä tavalla. Jääkiipeilyssä pääset kokeilemaan miltä tuntuu kiivetä pystysuoraa jääputousta."
}
