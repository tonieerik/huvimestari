...
const seo = {
  ...
  description:
    "Täyttääkö ystäväsi tai sukulaisesi pyöreitä vuosia? Haluaisitko yllättää läheisesi lahjalla, jota muistellaan taatusti vielä vuosienkin päästä?",
};
            ...
            <div className="relative shadow-xl sm:rounded-2xl sm:overflow-hidden">
              ...
              <div className="relative px-4 py-16 sm:px-6 sm:py-24 lg:py-32 lg:px-8">
                ...
                <p className="mt-6 max-w-lg mx-auto text-center text-xl text-gray-100 sm:max-w-3xl">
                  Täyttääkö ystäväsi tai sukulaisesi pyöreitä vuosia?
                  Haluaisitko yllättää läheisesi tällä kertaa aineettomalla
                  lahjalla, jota muistellaan taatusti vielä vuosienkin päästä?
                </p>
                <p className="mt-6 max-w-lg mx-auto text-center text-xl text-gray-100 sm:max-w-3xl">
                  Huvimestarin siltakeinu, köysilaskeutuminen ja
                  kalliokiipeilykokeilu ovat osuvia lahjoja, kun haluat antaa
                  lahjaksi jotakin ainutlaatuista. Kaikki elämyksemme sopivat
                  käytännössä junnusta muoriin.
                </p>
                <p className="mt-6 max-w-lg mx-auto text-center text-xl text-gray-100 sm:max-w-3xl">
                  Huvimestarin kesän kalenteri täyttyy nopeasti, joten varaathan
                  elämyslahjan pian!
                </p>
          ...
          <div className="max-w-7xl mx-auto py-2 px-4 sm:py-8 sm:px-6 lg:px-8">
            <div className="xl:grid xl:grid-cols-3 xl:gap-x-8">
              <h1 className="mt-2 text-3xl font-extrabold text-gray-900">
                Miksi valita köysielämys synttäriaktiviteetiksi Jyväskylässä?
              </h1>
              ...
              <div className="relative bg-yellow lg:col-start-3 lg:row-start-1 lg:col-span-10 lg:rounded-3xl lg:grid lg:grid-cols-10 lg:items-center">
                ...
                <div className="relative max-w-md mx-auto py-12 px-4 space-y-6 sm:max-w-3xl sm:py-16 sm:px-6 lg:max-w-none lg:p-0 lg:col-start-4 lg:col-span-6">
                  ...
                  <p className="text-lg text-gray-800">
                    Jyväskylän parhaat synttärit ovat vain klikkauksen päässä.
                    Kysy lisää vauhdikkaista synttärielämyksistämme tai varaa
