...
const services = [
  ...
  },
  {
    ...
    price: "200 €",
    description:
      "Kiipeily luonnon kallioilla on reipas valinta virkistyspäivään – luontoliikuntaa parhaimmillaan! Työporukan kiipeilykokeilu suunnitellaan aina ryhmäkohtaisesti, jotta jokainen pääsee haastamaan sopivasti itseään. Et tarvitse kuitenkaan aiempaa kiipeilykokemusta, voimaa tai notkeutta vaan kiipeily sopii käytännössä kenelle tahansa. Tässä virkistyspäivän aktiviteetissa yhteishenki hioutuu, kun kaikki tsemppaavat toisiaan.",
...
const seo = {
  title: "Yrityksen virkistyspäivä Jyväskylä | Huvimestari",
  description:
    "Aktiviteetteja yrityksen virkistyshetkiin, elämyksiä tyhy-päivään",
};
            ...
            <div className="relative shadow-xl sm:rounded-2xl sm:overflow-hidden">
              ...
              <div className="relative px-4 py-16 sm:px-6 sm:py-24 lg:py-32 lg:px-8">
                <h1 className="block text-gray-100 text-center text-4xl font-extrabold tracking-tight sm:text-5xl lg:text-6xl">
                  Aktiviteetteja yrityksen virkistyshetkiin, elämyksiä
                  tyhy-päivään
                </h1>
                <p className="mt-6 max-w-lg mx-auto text-center text-xl text-gray-100 sm:max-w-3xl">
                  Huvimestarin elämyksistä on kehkeytynyt monen yrityksen
                  virkistyspäivien kohokohta. Mikäpä hioisi työporukkaasi
                  paremmin yhteen kuin kaverin tsemppaaminen siltakeinun kyytiin
                  hypätessä tai mäkihyppytornista köyden varassa laskeutuessa?
                  Yhtä lailla kalliokiipeily ja jääkiipeily ovat sosiaalisia
                  lajeja, joissa oman tiimin kannustus kantaa pitkälle.
                </p>
                <p className="mt-6 max-w-lg mx-auto text-center text-xl text-gray-100 sm:max-w-3xl">
                  Räätälöimme jokaisen aktiviteettimme, oli se sitten
                  siltakeinu, köysilaskeutuminen tai kalliokiipeily, jokaiselle
                  työyhteisölle sopivaksi. Huolehdimme siitä, että jokainen
                  pääsee ylittämään itsensä turvallisissa olosuhteissa. Uskomme,
                  että työpaikan villeimmilläkin hepuilla hikoavat kämmenet.
                </p>
                <p className="mt-6 max-w-lg mx-auto text-center text-xl text-gray-100 sm:max-w-3xl">
                  Joka tapauksessa lopuksi hymy on herkässä ihan jokaisella.
                  Tämä jos mikä virkistyspäivä jää koko työporukan mieleen!
                </p>
                <p className="mt-6 max-w-lg mx-auto text-center text-xl text-gray-100 sm:max-w-3xl">
                  Kysy lisää yrityksille suunnatusta virkistyspäivän ohjelmasta
                  ja varaa työporukallesi elämyksellinen päivä nyt.
                </p>
                <div className="mt-10 max-w-sm mx-auto sm:max-w-none sm:flex sm:justify-center">
                  <div className="space-y-4 sm:space-y-0 sm:mx-auto sm:inline-grid sm:grid-cols-2 sm:gap-5">
                    ...
                    >
                      VARAA VIRKISTYSPÄIVÄN AKTIVITEETTI!
                    </a>
                  </div>
                </div>
              </div>
          ...
          <div className="max-w-7xl mx-auto py-2 px-4 sm:py-8 sm:px-6 lg:px-8">
            <div className="xl:grid xl:grid-cols-3 xl:gap-x-8">
              <h1 className="mt-2 text-3xl font-extrabold text-gray-900">
                Miksi valita köysielämys virkistyspäivän aktiviteetiksi
                Jyväskylässä?
              </h1>
              ...
              <div className="relative bg-yellow lg:col-start-3 lg:row-start-1 lg:col-span-10 lg:rounded-3xl lg:grid lg:grid-cols-10 lg:items-center">
                ...
                <div className="relative max-w-md mx-auto py-12 px-4 space-y-6 sm:max-w-3xl sm:py-16 sm:px-6 lg:max-w-none lg:p-0 lg:col-start-4 lg:col-span-6">
                  ...
                  <p className="text-lg text-gray-800">
                    Jyväskylän parhaat virkistyspäivät ovat vain klikkauksen
                    päässä. Kysy lisää vauhdikkaista virkistyspäivän
                    elämyksistämme tai varaa seurueellesi sopiva aktiviteetti
                    saman tien varauskalenteristamme. Erityisesti
                    kesäviikonloput viedään nopeasti käsistä, joten kipin kapin
                    varailemaan.
                  </p>
                  <a
