            ...
            <div className="relative shadow-xl sm:rounded-2xl sm:overflow-hidden">
              ...
              <div className="relative px-4 py-16 sm:px-6 sm:py-24 lg:py-32 lg:px-8">
                ...
                <p className="mt-6 max-w-lg mx-auto text-center text-xl text-gray-100 sm:max-w-3xl">
                  Huvimestarin elämyksistä on kehkeytynyt monen yrityksen virkistyspäivien kohokohta. Mikäpä hioisi työporukkaasi paremmin yhteen kuin kaverin tsemppaaminen siltakeinun kyytiin hypätessä tai mäkihyppytornista köyden varassa laskeutuessa? Yhtä lailla kalliokiipeily ja jääkiipeily ovat sosiaalisia lajeja, joissa oman tiimin kannustus kantaa pitkälle.
                </p>
                <p className="mt-6 max-w-lg mx-auto text-center text-xl text-gray-100 sm:max-w-3xl">
                  Räätälöimme jokaisen aktiviteettimme, oli se sitten siltakeinu, köysilaskeutuminen tai kalliokiipeily, jokaiselle työyhteisölle sopivaksi. Huolehdimme siitä, että jokainen pääsee ylittämään itsensä turvallisissa olosuhteissa. Uskomme, että työpaikan villeimmilläkin hepuilla hikoavat kämmenet.
                </p>
                <p className="mt-6 max-w-lg mx-auto text-center text-xl text-gray-100 sm:max-w-3xl">
                  Joka tapauksessa lopuksi hymy on herkässä ihan jokaisella. Tämä jos mikä virkistyspäivä jää koko työporukan mieleen!
                </p>
                <p className="mt-6 max-w-lg mx-auto text-center text-xl text-gray-100 sm:max-w-3xl">
                  Kysy lisää yrityksille suunnatusta virkistyspäivän ohjelmasta ja varaa työporukallesi elämyksellinen päivä nyt.
                </p>
        ...
        <div className="bg-white">
          <div className="max-w-7xl mx-auto py-2 px-4 sm:py-8 sm:px-6 lg:px-8">
            <div className="xl:grid xl:grid-cols-3 xl:gap-x-8">
              <h1 className="mt-2 text-3xl font-extrabold text-gray-900">Miksi valita köysielämys virkistyspäivän aktiviteetiksi Jyväskylässä?</h1>
            ...
            <div className="lg:grid lg:grid-cols-12">
              ...
              <div className="relative bg-yellow lg:col-start-3 lg:row-start-1 lg:col-span-10 lg:rounded-3xl lg:grid lg:grid-cols-10 lg:items-center">
                ...
                <div className="relative max-w-md mx-auto py-12 px-4 space-y-6 sm:max-w-3xl sm:py-16 sm:px-6 lg:max-w-none lg:p-0 lg:col-start-4 lg:col-span-6">
                  ...
                  Jyväskylän parhaat virkistyspäivät ovat vain klikkauksen päässä. Kysy lisää vauhdikkaista virkistyspäivän elämyksistämme tai varaa seurueellesi sopiva aktiviteetti saman tien varauskalenteristamme. Erityisesti kesäviikonloput viedään nopeasti käsistä, joten kipin kapin varailemaan.
                  </p>
                  <a
