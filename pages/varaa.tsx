...
export default function Book() {
  return (
    <Layout {...seo}>
        <iframe src="https://huvimestari-booking.netlify.app" title="Varauskalenteri" width="100%" height="2200"></iframe>
      {/* <div className="max-w-7xl mx-auto py-24 sm:px-6 lg:px-8">

        <div className="md:grid md:grid-cols-2 md:divide-x md:divide-gray-200">
          <div className="md:pr-14">
            <div className="flex items-center">
              <h2 className="flex-auto font-semibold text-gray-900">Tammikuu 2022</h2>
              <button
                type="button"
